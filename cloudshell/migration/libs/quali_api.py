...
class QualiAPISession(object):
    ...
    def ImportPackage(self, package_filepath):
        ...
        with open(package_filepath, "rb") as package_file:
            ...
            return self.validate_response(import_result, True)
    ...
    def ExportPackage(self, blueprint_full_names, target_filename):
        ...
        export_result = requests.post(self._api_base_url + "/Package/ExportPackage",
                                      json={"TopologyNames": blueprint_full_names},
                                      headers={"Authorization": self._auth_code})
        self.validate_response(export_result)
        with open(target_filename, "wb") as target_file:
            target_file.write(export_result.content)

    def validate_response(self, response, validate_json_result=False):
        """

        :param validate_json_result:
        ...
        if validate_json_result:
            ...
            error_message = resp_dict.get('ErrorMessage')
